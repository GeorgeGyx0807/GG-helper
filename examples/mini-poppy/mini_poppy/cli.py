...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Teaching-sized Poppy agent harness.")
    parser.add_argument("prompt", nargs="*", help="One-shot prompt. If omitted, mini-poppy starts a small REPL.")
...
def build_agent(args):
    ...
    run_store = RunStore(workspace.root / ".mini-poppy" / "runs")
    return Poppy(
...
def main(argv=None):
    ...
    while True:
        try:
            user_input = input("mini-poppy> ").strip()
